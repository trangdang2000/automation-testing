...
WebUI.click(findTestObject('Object Repository/Page_Automation Exercise - Signup  Login/form_Email Address already existSignup'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Automation Exercise - Signup  Login/p_Email Address already exist'))
